...
module.exports = (
  ...
  //       // Group by student, month, and year to separate beginning and ending
  //       {
  //         $group: {
  //           _id: {
  //             student_id: "$student_id",
  ...
  //       // Calculate progress for each lesson type
  //       {
  //         $project: {
  ...
  //                   },
  //                 },
  //                 // Line progress - Show page/line format
  //                 line_progress: {
  //                   $let: {
  //                     vars: {
  //                       startPage: {
  ...
  //           // Gift for Muslim progress (only for gift_muslim type) - FIXED: Use original type fields
  //           gift_for_muslim_progress: {
  //             $cond: [
  //               {
  //                 $and: [
  //                   { $eq: ["$ending.type", "gift_muslim"] }, // Use ending.type directly
  ...
  //           // Calculate monthly progress for each lesson type with proper field handling
  ...
  //           // FIXED: Gift for Muslim progress condition
  ...
  //                 1, // Count months with line progress instead of summing strings
  //                 0,
  //               ],
  //             },
  //           },
